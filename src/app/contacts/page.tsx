...
function ParticlesBackground() {
  ...
  const options = {
    ...
    particles: {
      color: { value: ["#00eaff", "#0088ff", "#ffffff"] },
      links: { enable: true, color: "#00eaff", distance: 120, opacity: 0.4 },
  ...
  return (
    <Particles id="contacts-particles" options={options} className="absolute inset-0 z-0" />
  );
}

const MemoizedParticles = React.memo(ParticlesBackground);
...
export default function Contacts() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black text-white overflow-hidden">
      <MemoizedParticles />
      <Navbar />
      <main className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 md:p-10 max-w-7xl mx-auto relative z-10">
        <motion.section
          initial={{ opacity: 0, x: -30 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
          className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-6 shadow flex flex-col"
        >
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold tracking-wide">Mis Contactos</h2>
            <button
              onClick={() => setShowModal(true)}
              className="flex items-center gap-2 px-3 py-2 rounded-lg font-medium bg-gradient-to-r from-cyan-500 to-blue-600 hover:opacity-90 transition text-sm shadow"
            >
              <UserPlus size={16} />
              Agregar
            </button>
        ...
        <motion.section
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
          className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-6 shadow flex flex-col justify-between overflow-hidden hover:shadow-cyan-500/20 hover:scale-[1.02] transition-transform duration-300"
        >
          <Particles
            id="task-box-particles"
            options={{
              background: { color: { value: "transparent" } },
              fpsLimit: 60,
              particles: {
                color: { value: ["#00eaff", "#0088ff", "#ffffff"] },
                links: { enable: true, color: "#00eaff", distance: 100, opacity: 0.3 },
          ...
          <motion.button
            ...
            className="relative z-10 flex items-center justify-center gap-3 px-6 py-3 rounded-lg font-medium bg-gradient-to-r from-cyan-500 to-blue-600 transition"
          >
          ...
          <div className="bg-slate-900 border border-white/10 rounded-xl shadow-lg w-full max-w-md p-6">
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500"
              />
              <input
                type="text"
